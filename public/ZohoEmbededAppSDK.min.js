...
var ZOHO = (function() {
  ...
  return {
      ...
      var newfile = new File([oldfile], oldfile.name, { type: oldfile.type });
          ...
          function getAllProfiles(Category, Type,data) {
              var data = {
                  category: Category,
                  type: Type,
                  APIData : data
          ...
          function getProfile(Category, Type,data) {
            ...
            if(requestData.FILE)
          {
              ...
              var data = {
                  ...
                  nameSpace: method,
                  data: reqData,
                  cacheControl : requestData['$Cache-Control'],
                  type:type
              };
              return newRequestPromise(data);
          };
          ...
          return {
              ...
              CONFIG: {
                   ...
                   *
                   */
                  getOrgInfo: function(APIData) {
                      return config("ORG",undefined,APIData);
                  },
                  /**
                   ...
                   *
                   */
                  getCurrentUser: function(APIData) {
                      return config("CURRENT_USER",undefined,APIData);
                  },
                  /*
         ...
         *
              ...
              API: {
                  ...
                  getRoleById: function(data){
                    data = data ? data : {};
                      return getRole("ROLE", data)
                  },
                  /**
                   * @function getContactRole
                   * @description To get all details of available contact roles.
                   * @returns {Promise} Resolved with details of the specified contact role.
                   * @memberof ZOHO.CRM.API
                   * @example
                   * ZOHO.CRM.API.getContactRole().then(function(response){
                   *      console.log(response);
                   * });
                   *
                   * //prints
                   ...
                   *       "id": "123456789101112132"
                   *     },
                   *     {
                   *       "sequence_number": 2,
                   *       "name": "Decision Maker",
                   *       "id": "123456789101112133"
                   *     },
                   *     {
                   *       "sequence_number": 3,
                   *       "name": "Purchasing",
                   ...
                   *       "id": "123456789101112135"
                   *     },
                   *     {
                   *       "sequence_number": 5,
                   *       "name": "Engineering Lead",
                   *       "id": "123456789101112136"
                   *     },
                   *     {
                   *       "sequence_number": 6,
                   *       "name": "Economic Decision Maker",
                   *       "id": "123456789101112137"
                   *     },
                   *     {
                   *       "sequence_number": 7,
                   *       "name": "Product Management",
                   *       "id": "123456789101112138"
                   *     }
                   *   ]
                   * }
                   */
                  getContactRole: function(data){
                    data = data ? data : {};
                    data.type = "CONTACT_ROLE";
                      return getRecord(data)
                  },
                  /**
                   * @function getContactRoleById
                   * @description To get all details of specific contact roles.
                   * @param {Object} config - Configuration Object.
                   * @param {String} config.RoleID - Contact Role ID
                   * @returns {Promise} Resolved with details of the specified contact role.
                   * @memberof ZOHO.CRM.API
                   * @example
                   * var config = {
                   *      "RoleID":"123456789101112137"
                   * }
                   * ZOHO.CRM.API.getContactRoleById(config).then(function(response){
                   *      console.log(response);
                   * });
                   *
                   * //prints
                   ...
                   * }
                   */
                  getContactRoleById: function(data){
                    data = data ? data : {};
                    data.type = "CONTACT_ROLE";
                      return getRecord(data)
                  },
            ...
            APIData.duplicate_check_fields = data.duplicate_check_fields.join(",")
                  ...
                  */
                  getBluePrint: function(data) {
                    data.action =  "GET_BLUEPRINT_STATUS"
                      return getBluePrint(data);
                  },
                  /**
                  ...
                  */
                  updateBluePrint: function(data) {
                    data.action ="UPDATE_BLUEPRINT_STATUS"; 
                      return getBluePrint(data);
                  },
                  /**
                  * @function uploadFile
         ...
         *	}
                  ...
                  getAllProfiles: function(data) {
                      ...
                      return getAllProfiles(category, type,data)
                  },
                  /**
                   * @function getProfile
                   * @memberof ZOHO.CRM.API
                  ...
                  getProfile: function(data) {
                      ...
                      return getProfile(category, type,data);
                  },
                  /**
                   ...
                   *
                   */
                  getOrgVariable: function(APIData) {
                    var nameSpace;
                    if(APIData instanceof Object)
                    {
                      if(APIData.nameSpace)
                      {
                        if(APIData.nameSpace instanceof Array)
                        {
                          nameSpace = {apiKeys:APIData.nameSpace};
                          delete APIData.nameSpace;
                        }
                        else
                        {
                      ...
                      else if(APIData.apiKeys)
                      {
                        nameSpace = {apiKeys:APIData.apiKeys};
                        delete APIData.apiKeys;
                      }
                    }
                    else
                  {
                      ...
                      return config("VARIABLE", nameSpace,APIData);
                  },
                  /**
                   * @function sendMail
                   * @memberof ZOHO.CRM.API
              ...
              UI: {
                  ...
                  Popup: {
                       ...
                       * @description to show Popup message
                       * @returns {Promise} resolved with true | false
                       * @memberof ZOHO.CRM.UI.Popup
                       * @example
                       * ZOHO.CRM.UI.Popup.showMessage({type:"error",message:"example popup message",delay:1000})
                       * .then(function(data){
                       *     console.log(data)
                       * })
                       */
                  ...
                  /**
                   * @namespace ZOHO.CRM.UI.Sidebar
                   */
                  Sidebar: {
                      /**
                       * @function open
                       * @description open a SideBar Widget with custom onLoad Data 
                       * @returns {Promise} resolved with true | false
                       * @memberof ZOHO.CRM.UI.Sidebar
                       * @example
                       * var message = {
                       * 		arg1:"Argument 1",
                       * 		arg2:"Argument 2",
                       ...
                       * }
                       * 
                       * ZOHO.CRM.UI.Sidebar.open({Message:message})
                       * .then(function(data){
                       *     console.log(data)
                       * })
                       */
                      ...
                      /**
                       * @function close
                       * @description close the SideBar Widget with custom onLoad Data 
                       * @returns {Promise} resolved with true | false
                       * @memberof ZOHO.CRM.UI.Sidebar
                       * ZOHO.CRM.UI.Sidebar.close()
                       * .then(function(data){
                       *     console.log(data)
                       * })
                       */
